...
import { Trophy, BookOpen, Code, CheckCircle } from "lucide-react";

export function FinalPractice() {
  ...
  return (
    <section id="section-10" className="min-h-screen flex items-center justify-center py-24 px-4 bg-slate-950/50">
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          <div className="inline-block bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-blue-500/30 rounded-2xl p-8">
